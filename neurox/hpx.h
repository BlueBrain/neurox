...
#define neurox_zero_var_action 0                 // no arguments
#define neurox_single_var_action 1               // one argument
#define neurox_several_vars_action 2             // more than one argument
#define neurox_single_var_compressed_action 3    // one argument compressed
#define neurox_several_vars_compressed_action 4  // more than one argument comp.
#define neurox_reduce_op_action 5  // HPX_FUNCTION for reduce operation
