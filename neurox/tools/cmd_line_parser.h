...
class CmdLineParser {
 public:
  ...
  bool all_reduce_at_locality_;  ///> whether to perform HPX all-reduce LCOs at
                                 /// neuron or node level
  bool load_balancing_;  ///> Whether to perform dynamic load balancing of bodes and branches
