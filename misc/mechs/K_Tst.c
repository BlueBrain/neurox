...
#define nrn_cur_parallel _nrn_cur_parallel__K_Tst
#define _nrn_current _nrn_current__K_Tst
#define nrn_jacob _nrn_jacob__K_Tst
#define nrn_ode_state _nrn_ode_state__K_Tst
#define initmodel initmodel__K_Tst
#define _net_receive _net_receive__K_Tst
#define nrn_ode_state_launcher nrn_ode_state_K_Tst_launcher
...
#define _ode_matsol1 _nrn_ode_matsol1__K_Tst
#define _ode_spec1 _nrn_ode_spec1__K_Tst
...
"K_Tst",
 ...
 void _nrn_ode_state_vars__K_Tst(short * count, short** var_offsets, short ** dv_offsets)
 {
     *count = 2;
