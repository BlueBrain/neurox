...
#define initmodel initmodel__Ca_HVA2
#define _net_receive _net_receive__Ca_HVA2
#define nrn_state_launcher nrn_state_Ca_HVA2_launcher
#define nrn_cur_launcher nrn_cur_Ca_HVA2_launcher
...
#define _slist1 _slist1_Ca_HVA2
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_Ca_HVA2
int* _dlist1;
