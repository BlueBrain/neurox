...
extern void 
  _nrn_cur_parallel__Ca(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__CaDynamics_E2(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__Ca_HVA(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__Ca_LVAst(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__Ih(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__Im(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__K_Pst(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__K_Tst(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__KdShu2007(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__NaTa_t(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__NaTs2_t(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__Nap_Et2(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__ProbAMPANMDA_EMS(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__ProbGABAAB_EMS(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__SK_E2(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__SKv3_1(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__StochKv(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__cc(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__ExpSyn(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__hh(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__pas(NrnThread*, Memb_list*, int),
  _nrn_cur_parallel__IClamp(NrnThread*, Memb_list*, int);

mod_parallel_f_t get_cur_parallel_function(const char * sym)
{
  if (strcmp(sym, "Ca") == 0)  return _nrn_cur_parallel__Ca;
  if (strcmp(sym, "CaDynamics_E2") == 0)  return _nrn_cur_parallel__CaDynamics_E2;
  if (strcmp(sym, "Ca_HVA") == 0)  return _nrn_cur_parallel__Ca_HVA;
  if (strcmp(sym, "Ca_LVAst") == 0)  return _nrn_cur_parallel__Ca_LVAst;
  if (strcmp(sym, "Ih") == 0)  return _nrn_cur_parallel__Ih;
  if (strcmp(sym, "Im") == 0)  return _nrn_cur_parallel__Im;
  if (strcmp(sym, "K_Pst") == 0)  return _nrn_cur_parallel__K_Pst;
  if (strcmp(sym, "K_Tst") == 0)  return _nrn_cur_parallel__K_Tst;
  if (strcmp(sym, "KdShu2007") == 0)  return _nrn_cur_parallel__KdShu2007;
  if (strcmp(sym, "NaTa_t") == 0)  return _nrn_cur_parallel__NaTa_t;
  if (strcmp(sym, "NaTs2_t") == 0)  return _nrn_cur_parallel__NaTs2_t;
  if (strcmp(sym, "Nap_Et2") == 0)  return _nrn_cur_parallel__Nap_Et2;
  if (strcmp(sym, "ProbAMPANMDA_EMS") == 0)  return _nrn_cur_parallel__ProbAMPANMDA_EMS;
  if (strcmp(sym, "ProbGABAAB_EMS") == 0)  return _nrn_cur_parallel__ProbGABAAB_EMS;
  if (strcmp(sym, "SK_E2") == 0)  return _nrn_cur_parallel__SK_E2;
  if (strcmp(sym, "SKv3_1") == 0)  return _nrn_cur_parallel__SKv3_1;
  if (strcmp(sym, "StochKv") == 0)  return _nrn_cur_parallel__StochKv;
  if (strcmp(sym, "cc") == 0)  return _nrn_cur_parallel__cc;
  if (strcmp(sym, "ExpSyn") == 0)  return _nrn_cur_parallel__ExpSyn;
  if (strcmp(sym, "hh") == 0)  return _nrn_cur_parallel__hh;
  if (strcmp(sym, "pas") == 0)  return _nrn_cur_parallel__pas;
  if (strcmp(sym, "IClamp") == 0)  return _nrn_cur_parallel__IClamp;
  return NULL;
}
