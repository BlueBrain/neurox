...
#define nrn_ode_state _nrn_ode_state__Ca_LVAst
#define initmodel initmodel__Ca_LVAst
#define _net_receive _net_receive__Ca_LVAst
#define nrn_ode_state_launcher nrn_ode_state_Ca_LVAst_launcher
...
#define _ode_matsol1 _nrn_ode_matsol1__Ca_LVAst
#define _ode_spec1 _nrn_ode_spec1__Ca_LVAst
...
"Ca_LVAst",
 ...
 void _nrn_ode_state_vars__Ca_LVAst(short * count, short** var_offsets, short ** dv_offsets)
 {
     *count = 2;
