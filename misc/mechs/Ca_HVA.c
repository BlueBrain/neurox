...
#define nrn_cur_parallel _nrn_cur_parallel__Ca_HVA
#define _nrn_current _nrn_current__Ca_HVA
#define nrn_jacob _nrn_jacob__Ca_HVA
#define nrn_ode_state _nrn_ode_state__Ca_HVA
#define initmodel initmodel__Ca_HVA
#define _net_receive _net_receive__Ca_HVA
#define nrn_ode_state_launcher nrn_ode_state_Ca_HVA_launcher
