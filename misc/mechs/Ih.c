...
#define nrn_cur_parallel _nrn_cur_parallel__Ih
#define _nrn_current _nrn_current__Ih
#define nrn_jacob _nrn_jacob__Ih
#define nrn_ode_state _nrn_ode_state__Ih
#define initmodel initmodel__Ih
#define _net_receive _net_receive__Ih
#define nrn_ode_state_launcher nrn_ode_state_Ih_launcher
...
#define _ode_matsol1 _nrn_ode_matsol1__Ih
#define _ode_spec1 _nrn_ode_spec1__Ih
...
"Ih",
 ...
 void _nrn_ode_state_vars__Ih(short * count, short** var_offsets, short ** dv_offsets)
 {
     *count = 1;
