...
#define t _nt->_t
#define dt _nt->_dt
#define ping _p[0*_STRIDE]
#define index _p[1*_STRIDE]
#define etime _p[2*_STRIDE]
#define space _p[3*_STRIDE]
#define _v_unused _p[4*_STRIDE]
#define _tsav _p[5*_STRIDE]
...
#error AoSoA not implemented.
...
#endif
 {
   if ( _lflag  == 1.0 ) {
     ...
     artcell_net_send ( _tqitem, _weight_index, _pnt, t +  ping , 2.0 ) ;
     }
   } 
#if NET_RECEIVE_BUFFERING
#undef t
...
/*VERBATIM*/
 ...
 index = 0.0 ;
   ...
   if ( ping > 0.0 ) {
     artcell_net_send ( _tqitem, -1, (Point_process*) _nt->_vdata[_ppvar[1*_STRIDE]], t +  ping , 2.0 ) ;
     }
