...
#define NMDA_ratio _p[14*_STRIDE]
#define i _p[15*_STRIDE]
#define i_AMPA _p[16*_STRIDE]
#define i_NMDA _p[17*_STRIDE]
#define g_AMPA _p[18*_STRIDE]
#define g_NMDA _p[19*_STRIDE]
#define g _p[20*_STRIDE]
#define A_AMPA_step _p[21*_STRIDE]
#define B_AMPA_step _p[22*_STRIDE]
#define A_NMDA_step _p[23*_STRIDE]
#define B_NMDA_step _p[24*_STRIDE]
#define unoccupied _p[25*_STRIDE]
#define occupied _p[26*_STRIDE]
#define tsyn _p[27*_STRIDE]
#define u _p[28*_STRIDE]
#define A_AMPA _p[29*_STRIDE]
#define B_AMPA _p[30*_STRIDE]
#define A_NMDA _p[31*_STRIDE]
#define B_NMDA _p[32*_STRIDE]
#define factor_AMPA _p[33*_STRIDE]
#define factor_NMDA _p[34*_STRIDE]
#define mggate _p[35*_STRIDE]
#define usingR123 _p[36*_STRIDE]
#define DA_AMPA _p[37*_STRIDE]
#define DB_AMPA _p[38*_STRIDE]
#define DA_NMDA _p[39*_STRIDE]
#define DB_NMDA _p[40*_STRIDE]
#define _v_unused _p[41*_STRIDE]
#define _g_unused _p[42*_STRIDE]
#define _tsav _p[43*_STRIDE]
