...
#define _ode_matsol1 _nrn_ode_matsol1__Ca
#define _ode_spec1 _nrn_ode_spec1__Ca
...
"Ca",
 ...
 void _nrn_ode_state_vars__Ca(short * count, short** var_offsets, short ** dv_offsets)
 {
     *count = 2;
