...
#define initmodel initmodel__CaDynamics_DC0
...
#define surftovol _p[3*_STRIDE]
#define cai _p[4*_STRIDE]
#define Dcai _p[5*_STRIDE]
...
#define diam	_nt->_data[_ppvar[3*_STRIDE]]
...
#define h _mlhh
 ...
 #define FARADAY FARADAY_CaDynamics_DC0
 #define PI PI_CaDynamics_DC0
...
#define minCai minCai_CaDynamics_DC0
 ...
 #pragma acc declare copyin (minCai)
 
static void _acc_globals_update() {
 #pragma acc update device (minCai) if(nrn_threads->compute_gpu)
 }
...
#define _slist1 _slist1_CaDynamics_DC0
int* _slist1;
#pragma acc declare create(_slist1)

#define _dlist1 _dlist1_CaDynamics_DC0
int* _dlist1;
