...
#define nrn_cur_parallel _nrn_cur_parallel__SKv3_1
#define _nrn_current _nrn_current__SKv3_1
#define nrn_jacob _nrn_jacob__SKv3_1
#define nrn_ode_state _nrn_ode_state__SKv3_1
#define initmodel initmodel__SKv3_1
#define _net_receive _net_receive__SKv3_1
#define nrn_ode_state_launcher nrn_ode_state_SKv3_1_launcher
...
#define _ode_matsol1 _nrn_ode_matsol1__SKv3_1
#define _ode_spec1 _nrn_ode_spec1__SKv3_1
...
"SKv3_1",
 ...
 void _nrn_ode_state_vars__SKv3_1(short * count, short** var_offsets, short ** dv_offsets)
 {
     *count = 1;
