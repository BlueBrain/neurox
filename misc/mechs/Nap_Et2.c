...
#define nrn_cur_parallel _nrn_cur_parallel__Nap_Et2
#define _nrn_current _nrn_current__Nap_Et2
#define nrn_jacob _nrn_jacob__Nap_Et2
#define nrn_ode_state _nrn_ode_state__Nap_Et2
#define initmodel initmodel__Nap_Et2
#define _net_receive _net_receive__Nap_Et2
#define nrn_ode_state_launcher nrn_ode_state_Nap_Et2_launcher
...
#define _ode_matsol1 _nrn_ode_matsol1__Nap_Et2
#define _ode_spec1 _nrn_ode_spec1__Nap_Et2
...
"Nap_Et2",
 ...
 void _nrn_ode_state_vars__Nap_Et2(short * count, short** var_offsets, short ** dv_offsets)
 {
     *count = 2;
