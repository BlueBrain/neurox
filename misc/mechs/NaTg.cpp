...
#define ttxo _p[9*_STRIDE]
#define ttxi _p[10*_STRIDE]
#define ena _p[11*_STRIDE]
#define mInf _p[12*_STRIDE]
#define mTau _p[13*_STRIDE]
#define mAlpha _p[14*_STRIDE]
#define mBeta _p[15*_STRIDE]
#define hInf _p[16*_STRIDE]
#define hTau _p[17*_STRIDE]
#define hAlpha _p[18*_STRIDE]
#define hBeta _p[19*_STRIDE]
#define Dm _p[20*_STRIDE]
#define Dh _p[21*_STRIDE]
